 ...
 * @description: 圆圈干扰验证码
 */
public class ZHCircleCaptcha  extends AbstractCaptcha {
     ...
     * @param height 图片高
     */
    public ZHCircleCaptcha(int width, int height) {
        this(width, height, 5);
    }
     ...
     */
    public ZHCircleCaptcha(int width, int height, int codeCount) {
     ...
     */
    public ZHCircleCaptcha(int width, int height, int codeCount, int interfereCount) {
